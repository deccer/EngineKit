...
namespace EngineKit.Mathematics
{
    ...
    public struct Double2 : IEquatable<Double2>, IFormattable
    {
        ...
        /// <remarks>
        /// <see cref="DistanceSquared(ref EngineKit.Mathematics.Double2,ref EngineKit.Mathematics.Double2,out double)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        /// <remarks>
        /// <see cref="DistanceSquared(EngineKit.Mathematics.Double2,EngineKit.Mathematics.Double2)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
