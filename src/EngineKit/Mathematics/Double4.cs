...
namespace EngineKit.Mathematics
{
    ...
    public struct Double4 : IEquatable<Double4>, IFormattable
    {
        ...
        /// <remarks>
        /// <see cref="DistanceSquared(ref EngineKit.Mathematics.Double4,ref EngineKit.Mathematics.Double4,out double)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        /// <remarks>
        /// <see cref="DistanceSquared(EngineKit.Mathematics.Double4,EngineKit.Mathematics.Double4)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
