...
namespace EngineKit.Mathematics
{
    ...
    public struct Double3 : IEquatable<Double3>, IFormattable
    {
        ...
        /// <remarks>
        /// <see cref="DistanceSquared(ref EngineKit.Mathematics.Double3,ref EngineKit.Mathematics.Double3,out double)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        /// <remarks>
        /// <see cref="DistanceSquared(EngineKit.Mathematics.Double3,EngineKit.Mathematics.Double3)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
